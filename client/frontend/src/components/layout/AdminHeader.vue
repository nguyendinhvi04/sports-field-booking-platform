                ...
                <li class="nav-item dropdown language-dropdown more-dropdown">
                    <div class="dropdown custom-dropdown-icon">
                        <a class="dropdown-toggle btn" href="#" role="button" id="customDropdown" data-toggle="dropdown"
                            aria-haspopup="true" aria-expanded="false"><img src="../../assets/assets/img/flag-ca.svg"
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="customDropdown">
                            <a class="dropdown-item" data-img-value="flag-de" data-value="German"
                                href="javascript:void(0);"><img src="../../assets/assets/img/flag-de.svg" class="flag-width"
                                    alt="flag"> German</a>
                            <a class="dropdown-item" data-img-value="flag-sp" data-value="Spanish"
                                href="javascript:void(0);"><img src="../../assets/assets/img/flag-sp.svg" class="flag-width"
                                    alt="flag"> Spanish</a>
                            <a class="dropdown-item" data-img-value="flag-fr" data-value="French"
                                href="javascript:void(0);"><img src="../../assets/assets/img/flag-fr.svg" class="flag-width"
                                    alt="flag"> French</a>
                            <a class="dropdown-item" data-img-value="flag-ca" data-value="English"
                                href="javascript:void(0);"><img src="../../assets/assets/img/flag-ca.svg" class="flag-width"
                                    alt="flag"> English</a>
                        </div>
                    </div>
                </li>
                ...
                <li class="nav-item dropdown user-profile-dropdown order-lg-0 order-1">
                    <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="user-profile-dropdown"
                        ...
                        <div class="media">
                            ...
                            <img src="../../assets/assets/img/120x120.jpg" class="img-fluid" alt="admin-profile">
